...
void halbb_ra_init(struct bb_info *bb)
{
	...
	// phydm_arfr_table_init

	/*ARFR table3(2.4g ac 2ss) for rate_id = 16*/
	halbb_set_reg(bb, 0x494, MASKDWORD, 0xfe01f015);
	halbb_set_reg(bb, 0x498, MASKDWORD, 0x40000000);

	/*ARFR table5(2.4g ac 1ss) for rate_id = 18*/
	halbb_set_reg(bb, 0x4a4, MASKDWORD, 0x3ff015);
	halbb_set_reg(bb, 0x4a8, MASKDWORD, 0x40000000);
}
